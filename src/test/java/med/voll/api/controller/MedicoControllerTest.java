...
class MedicoControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver código http 400 quando dados de cadastro forem inválidos")
    @WithMockUser
    ...
    void cadastrar_cenario2() throws Exception {
        ...
        when(repository.save(any())).thenReturn(new Medico(dadosCadastro)); //Esse mock intercepta a chamada ao serviço real
